// i2c_oled_ni2_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module i2c_oled_ni2_mm_interconnect_0 (
	...
	wire  [15:0] i2c_0_csr_agent_m0_address;                                                         // i2c_0_csr_agent:m0_address -> i2c_0_csr_translator:uav_address
	...
	wire  [92:0] i2c_0_csr_agent_rf_source_data;                                                     // i2c_0_csr_agent:rf_source_data -> i2c_0_csr_agent_rsp_fifo:in_data
	...
	wire  [92:0] i2c_0_csr_agent_rsp_fifo_out_data;                                                  // i2c_0_csr_agent_rsp_fifo:out_data -> i2c_0_csr_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> i2c_0_csr_agent:cp_data
	...
	wire  [15:0] uart_0_s1_agent_m0_address;                                                         // uart_0_s1_agent:m0_address -> uart_0_s1_translator:uav_address
	...
	wire  [92:0] uart_0_s1_agent_rf_source_data;                                                     // uart_0_s1_agent:rf_source_data -> uart_0_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] uart_0_s1_agent_rsp_fifo_out_data;                                                  // uart_0_s1_agent_rsp_fifo:out_data -> uart_0_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> uart_0_s1_agent:cp_data
	...
	wire  [91:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [91:0] i2c_0_csr_agent_rp_data;                                                            // i2c_0_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [91:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [91:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_007:sink_data
	...
	i2c_oled_ni2_mm_interconnect_0_router router (
	...
	i2c_oled_ni2_mm_interconnect_0_router router_001 (
	...
	i2c_oled_ni2_mm_interconnect_0_router_002 router_002 (
	...
	i2c_oled_ni2_mm_interconnect_0_router_002 router_003 (
	...
	i2c_oled_ni2_mm_interconnect_0_router_002 router_004 (
	...
	i2c_oled_ni2_mm_interconnect_0_router_002 router_005 (
	...
	i2c_oled_ni2_mm_interconnect_0_router_002 router_006 (
	...
	i2c_oled_ni2_mm_interconnect_0_router_002 router_007 (
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	i2c_oled_ni2_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
