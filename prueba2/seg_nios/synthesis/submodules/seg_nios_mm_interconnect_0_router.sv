...
module seg_nios_mm_interconnect_0_router_default_decode
  #(
...
module seg_nios_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    seg_nios_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x3058 .. 0x3060 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 14'h3058  && read_transaction  ) begin
