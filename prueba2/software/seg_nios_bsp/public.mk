...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../seg_nios.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x3058
SOPC_SYSID_FLAG += --sidp=0x3058
ELF_PATCH_FLAG  += --sidp 0x3058

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1765998864
SOPC_SYSID_FLAG += --timestamp=1765998864
ELF_PATCH_FLAG  += --timestamp 1765998864
